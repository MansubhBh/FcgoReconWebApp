        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active">
                        <a id="dashboard" href=""><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>
                    </li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           DTCO Dashboard <small>Statistics Overview</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Paying Office 
                            </li>
                        </ol>
                    </div>
                </div>
    <div class="col-sm-3" style="float: right; margin-bottom: 10px">
    <button class="btn btn-block btn-danger" onclick="showEntryForm()"> Reconcile</button></div>
                
                
    <table id="poevaluatetable" class="table table-bordered table-hover table-striped" style="margin-top:20px; width:100%;">
                    
                    <thead style="background: #B8B2B1;">
                        <tr>
                            <th style="width: 90px">Po-Code</th>
                            <th>Paying Office</th>
